  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-w-[calc(100%-1rem)] p-0 overflow-hidden">
        <DialogHeader className="px-3 pt-4 sm:px-5 sm:pt-5">
        ...
        <div className="px-3 pb-4 pt-1 sm:px-5 sm:pb-5 space-y-3 sm:space-y-4 max-h-[80vh] overflow-y-auto">
          {/* Mode toggle */}
...
function Slot({
  ...
  return (
    <div className="border rounded-lg overflow-hidden bg-muted/20">
      <div className="px-2 py-1.5 sm:px-3 sm:py-2 border-b bg-muted/30 flex items-center justify-between gap-1">
        <div className="min-w-0">
          <p className="text-[11px] sm:text-xs font-semibold truncate">{label}</p>
          <p className="text-[10px] text-muted-foreground line-clamp-2 sm:truncate">{hint}</p>
        </div>
        {item && (
          <button
            type="button"
      ...
      {item ? (
        ...
        <div
          ...
          className={`aspect-square flex flex-col items-center justify-center gap-2 p-2 sm:p-4 transition-colors ${
        ...
        >
          {uploading ? (
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-1 sm:gap-1.5 w-full sm:w-auto">
                <Button
                  type="button"
                  size="sm"
                  variant="outline"
...
function LibraryPicker({ media, accept, onPick, onClose }: LibraryPickerProps) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-3xl max-h-[90vh] sm:max-h-[80vh] flex flex-col rounded-lg border bg-background shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 px-3 py-2.5 sm:px-4 sm:py-3 border-b">
          <div className="flex items-center gap-2">
            <p className="text-sm font-semibold flex-1 truncate">
              Pick {accept === "image" ? "an image" : "a video"}
            </p>
            <button
              type="button"
              onClick={onClose}
          ...
          <input
            ...
            className="h-8 rounded-md border bg-background px-2 text-xs w-full sm:w-44"
            autoFocus
          />
          <button
            type="button"
